 ...
 *                -- L[1] == 100; all equal --
 *  if i32                                      if i32
 *    i32.const 2                                 i32.const 2   ; v3
 *    local.get 1 // constant                     i32.const 100
 *    i32.add                                     i32.add
 *  else                                        else
...
let src_adjs
  ...
  [ (1, [], [(2, Jump)]);
    ...
    (3, [const 2; local_get 1; binary Ast.IntOp.Add],
        [(5, Jump)]);
